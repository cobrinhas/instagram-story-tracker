...
import { FakeInstagramAuthenticationRepository, FakeInstagramUserRepository, PrivateApiInstagramAuthenticationRepository, PrivateApiInstagramUserRepository } from "./data";
