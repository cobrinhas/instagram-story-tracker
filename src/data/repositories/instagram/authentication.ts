...
export class FakeInstagramAuthenticationRepository implements InstagramAuthenticationRepository {
    authenticate(credentials: InstagramCredentials): Promise<void> {
        return Promise.resolve();
    }
}

export class PrivateApiInstagramAuthenticationRepository implements InstagramAuthenticationRepository {
