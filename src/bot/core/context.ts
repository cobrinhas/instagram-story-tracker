...
export function botContext(context: Context, vault: Vault): BotContext {
	...
	return Object.assign(context, {
		...
		authenticationRepository: vault.lookup<InstagramAuthenticationRepository>(
			'InstagramAuthenticationRepository'
		)!,
		userRepository: vault.lookup<InstagramUserRepository>(
			'InstagramUserRepository'
		)!
	});
}
