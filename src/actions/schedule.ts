...
export function scheduleActivityTracking(
	...
	const userRepository = vault.lookup<InstagramUserRepository>(
		'InstagramUserRepository'
	)!;
...
export function scheduleAuthentication(config: Config, vault: Vault) {
	const authenticationRepository =
		vault.lookup<InstagramAuthenticationRepository>(
			'InstagramAuthenticationRepository'
		)!;
